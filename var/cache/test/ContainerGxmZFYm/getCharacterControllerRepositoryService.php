 ...
 */
class getCharacterControllerRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\CharacterControllerRepository' shared autowired service.
     *
     * @return \App\Repository\CharacterControllerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CharacterControllerRepository.php';

        return $container->privates['App\\Repository\\CharacterControllerRepository'] = new \App\Repository\CharacterControllerRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
