 ...
 */
class getCharacterVoter2Service extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['debug.security.voter.App\\Security\\Voter\\CharacterVoter'] = new \Symfony\Component\Security\Core\Authorization\Voter\TraceableVoter(($container->privates['App\\Security\\Voter\\CharacterVoter'] ?? ($container->privates['App\\Security\\Voter\\CharacterVoter'] = new \App\Security\Voter\CharacterVoter())), ($container->services['event_dispatcher'] ?? $container->getEventDispatcherService()));
    }
}
